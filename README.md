  ...
  <div class="container">
    ...
    <nav class="card">
      <div class="tabs" role="tablist" aria-label="Pestañas del sitio">
        ...
        <button class="tab-btn" data-tab="experiencia">Mi experiencia</button>
        <button class="tab-btn" data-tab="buenas">Buenas prácticas</button>
        <button class="tab-btn" data-tab="apa">Mi guía APA</button>
        <button class="tab-btn" data-tab="referencias">Referencias</button>
      </div>
    </nav>

    <!-- ---------- Inicio ---------- -->
    <section id="inicio" class="card tabpanel">
      <div class="grid">
        <div>
